...
import com.longdian.fragment.weather.model.*;
...
//            setImage(mHumidityTv, R.drawable.ic_humidity20);
    ...
    private void setUpdateTime(WeatherInfo weatherInfo) {
        mUpdateTimeTv.setText(String.format(getString(R.string.release_time), weatherInfo.getUpdateTime()));
