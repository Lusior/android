...
public class WaterAnalysisFragment1 extends Fragment implements AnalysisFragment{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        List<Map<String, String>> lists = WaterAnalysisFragment.sortList;
    ...
    private List<Map<String, String>> readyData(List<Map<String, String>> lists) {
        ...
        for (Map<String, String> s : lists) {
            ...
            row.put("key", s.get("stand_name"));
            row.put("key1", s.get("ft3q_total") + "kg");
            row.put("key2", NumberUtil.formatNum(s.get("yxdhstr"), 2) + "kg/m²");
